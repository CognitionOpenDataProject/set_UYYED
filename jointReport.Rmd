...
Also NB - the authors actually interpret p = .05 as statistically significant. As the correct value is .04, this description is accurate, so we will not consider this a decision error.
